...
<head>
	...
	<title>Worchit – Movies & TV Shows, Online cinema HTML Template</title>

</head>

<body>
	<!-- header (hidden style) -->
	<header class="header header--hidden" data-component="header">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="header__content">
						...
						<ul class="header__nav">
							<li class="header__nav-item">
								<a class="header__nav-link" href="catalog.html#" role="button" id="dropdownMenu2"  aria-haspopup="true" aria-expanded="false">Home <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

								
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="catalog.html" role="button" id="dropdownMenu1"  aria-haspopup="true" aria-expanded="false">Categories <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

								
							</li>
								<li class="header__nav-item">
								<a class="header__nav-link" href="catalog.html" role="button" id="dropdownMenu1"  aria-haspopup="true" aria-expanded="false">Pricing Plans <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>
							...
							<li class="header__nav-item">
								<a class="header__nav-link header__nav-link--more" href="catalog.html#" role="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	...
	<!-- details -->
	<section class="section section--head section--head-fixed section--gradient section--details-bg" data-component="details">
		...
		<div class="container">
			...
			<div class="article">
					...
					<div class="col-12 col-xl-8">
						...
						<div class="article__actions article__actions--details">
							<div class="article__download">
								...
								Download:
								<a href="details.html#" download="#">480p</a>
								<a href="details.html#" download="#">720p</a>
								<a href="details.html#" download="#">1080p</a>
								<a href="details.html#" download="#">4k</a>
							</div>
							...
							<div class="section__carousel-wrap">
								<div class="section__series owl-carousel" id="series">
									<div class="series">
										...
										<h3 class="series__title"><a href="html">1st series</a></h3>
									</div>
				...
				<div class="row" data-component="reviews">
					<div class="col-12 col-xl-8">
						...
						<div class="comments">
							...
							<ul class="nav nav-tabs comments__title comments__title--tabs" id="comments__tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="details.html#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">
										<h4>Comments</h4>
										<span>5</span>
									</a>
								</li>
								...
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="details.html#tab-2" role="tab" aria-controls="tab-2" aria-selected="false">
										<h4>Reviews</h4>
										<span>3</span>
									</a>
								</li>
								...
								<div class="tab-pane fade show active" id="tab-1" role="tabpanel">
									...
									<div class="catalog__paginator-wrap catalog__paginator-wrap--comments">
										...
										<ul class="catalog__paginator">
											...
											<li class="active"><a href="details.html#">1</a></li>
					...
					<div class="col-12 col-xl-4" data-component="notifications">
						<div class="sidebar sidebar--mt">
							...
							<!-- new items -->
							<div class="row row--grid" data-component="new">
								<div class="col-12">
	...
	<!-- similar -->
	<section class="section" data-component="similar">
		<div class="container">
			<div class="row">
				<div class="col-12">
