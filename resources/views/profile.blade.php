...
<head>
	...
	<title>Worchit – Movies & TV Shows, </title>
...
<a href="/" class="header__logo">
							<img src="img/logo.png" alt="Movies & TV Shows, " style="width:160px;height:80px;">
						</a>

						<ul class="header__nav">
							<li class="header__nav-item">
								<a class="header__nav-link" href="catalog" role="button" id="dropdownMenu2"  aria-haspopup="true" aria-expanded="false">Home <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

								
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="catalog" role="button" id="dropdownMenu1"  aria-haspopup="true" aria-expanded="false">Categories <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>

								
							</li>
								<li class="header__nav-item">
								<a class="header__nav-link" href="catalog" role="button" id="dropdownMenu1"  aria-haspopup="true" aria-expanded="false">Pricing Plans <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1.93893 3.30334C1.08141 3.30334 0.384766 2.60669 0.384766 1.75047C0.384766 0.894254 1.08141 0.196308 1.93893 0.196308C2.79644 0.196308 3.49309 0.894254 3.49309 1.75047C3.49309 2.60669 2.79644 3.30334 1.93893 3.30334Z"/></svg></a>
	...
	<!-- head -->
	<section class="section section--head" data-component="profilehead">
		<div class="container">
			<div class="row">
	...
	<!-- profile -->
	<div class="catalog catalog--page"data-component="profile">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="profile">
						...
						<ul class="nav nav-tabs profile__tabs" id="profile__tabs" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="profile.html#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">Profile</a>
							</li>

							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="profile.html#tab-2" role="tab" aria-controls="tab-2" aria-selected="false">Favorites</a>
							</li>

							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="profile.html#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Settings</a>
							</li>
						</ul>
						<!-- end tabs nav -->
				...
				<div class="tab-pane fade show active" id="tab-1" role="tabpanel">
					<div class="row row--grid">
						...
						<div class="col-12 col-sm-6 col-xl-3">
							<div class="stats">
								<span>My balance <a href="profile.html#modal-topup" class="open-modal">top up</a></span>
								<p><b>&#8358;90</b></p>
						...
						<div class="col-12 col-sm-6 col-xl-3">
							<div class="stats">
								...
								<p><a href="profile.html#">2 573</a></p>
						...
						<div class="col-12 col-sm-6 col-xl-3">
							<div class="stats">
								...
								<p><a href="profile.html#">1 021</a></p>
							...
							<div class="dashbox">
								<div class="dashbox__title">
									...
									<div class="dashbox__wrap">
										<a class="dashbox__refresh" href="profile.html#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z"></path></svg></a>
								...
								<div class="dashbox__table-wrap dashbox__table-wrap--1">
									<table class="main__table main__table--dash">
										...
										<tbody>
											<tr>
												<td>
													<div class="main__table-text"><a href="profile.html#">I Dream in Another Language</a></div>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="main__table-text"><a href="profile.html#">Benched</a></div>
												</td>
												<td>
													<div class="main__table-text">Movie</div>
												</td>
											...
											<tr>
												<td>
													<div class="main__table-text"><a href="profile.html#">Whitney</a></div>
												</td>
												<td>
											...
											<tr>
												<td>
													<div class="main__table-text"><a href="profile.html#">Blindspotting 2</a></div>
												</td>
												<td>
													<div class="main__table-text">TV Show</div>
												</td>
											...
											<tr>
												<td>
													<div class="main__table-text"><a href="profile.html#">Blindspotting</a></div>
												</td>
												<td>
													<div class="main__table-text">TV Show</div>
												</td>
						...
						<div class="col-12 col-xl-6">
							<div class="dashbox">
								<div class="dashbox__title">
									...
									<div class="dashbox__wrap">
										<a class="dashbox__refresh" href="profile.html#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z"></path></svg></a>
										<a class="dashbox__more" href="profile.html#">View All</a>
									</div>
								</div>
						...
						<div class="col-12">
							<div class="catalog__paginator-wrap">
								...
								<ul class="catalog__paginator">
									...
									<li class="active"><a href="profile.html#">1</a></li>
									<li><a href="profile.html#">2</a></li>
									<li><a href="profile.html#">3</a></li>
									<li><a href="profile.html#">4</a></li>
									<li>
										<a href="profile.html#">
			...
			<div class="row">
				<div class="col-12">
					<div class="partners owl-carousel">
						<a href="profile.html#" class="partners__img">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0 offset-xl-1">
					<h6 class="footer__title">Worchit</h6>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© Worchit.template, 2021. Created by.</small>
					</div>
				</div>
			</div>
		</div>
